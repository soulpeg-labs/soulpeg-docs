...
const sidebarNavItems = [
    ...
    },
    {
        ...
        items: [
            ...
            { title: "Audit Status", href: "/docs/faq/audit-status" }
        ],
    },
    {
        title: "Whitepaper",
...
export function MobileSidebar({ isOpen, onClose }: MobileSidebarProps) {
    ...
    return (
        <>
            ...
            {/* Sidebar */}
            <div className="fixed left-0 top-0 h-full w-80 bg-soulpeg-dark border-r border-soulpeg-border z-[101] md:hidden overflow-y-auto">
                <div className="flex items-center justify-between p-4 border-b border-soulpeg-border">
